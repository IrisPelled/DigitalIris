...
- **base:** האתר יופיע בכתובת `https://irispelled.github.io/Digitallris/`
...
1. היכנסי לריפו: **https://github.com/IrisPelled/Digitallris**
...
- האתר יהיה זמין ב: **https://irispelled.github.io/Digitallris/**

## הרצה מקומית עם base של Pages

```bash
npm run build:pages
npx vite preview --base /Digitallris/
```
